...
public class OsMowSisViewer extends JFrame {
    ...
    //Added by Ricardo Duran
    public static boolean hitStart = false;
    ...
    //Added by Ricardo Duran
    static private JButton startButton = new JButton("Start");
    ...
    public void createDisplay() {
        ...
        startButton.addActionListener(ae -> hitStart = true);
