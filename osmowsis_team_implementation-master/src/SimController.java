...
public class SimController {
    //    private OsMowSisViewer viewer = new OsMowSisViewer(); made this public to access it from OsMowSis.java
    public static OsMowSisViewer viewer = new OsMowSisViewer();
